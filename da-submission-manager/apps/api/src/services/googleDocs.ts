...
`;
        ...
        // 4. Transfer ownership to avoid service account quota limits
        // Use the owner email from an environment variable if set
        ...
        // 5. Set permissions (make it editable by anyone with link)
        await this.drive.permissions.create({
          fileId: newDocId,
          requestBody: {
            role: 'writer',
        ...
        // 6. Move to specified folder if configured
