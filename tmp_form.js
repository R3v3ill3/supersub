...
(function() {
	...
	if (widget_id == '') {
		widget_id = '2025_objection_submission'
	}

	if (widget_dom_id == '') {
		widget_dom_id = 'can-form-area-2025-objection-submission'
	}
